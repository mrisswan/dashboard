...
export default class User extends React.Component {
  ...
  getTanggalUser = (event) => {
    ...
    if (this.state.awal === "" || this.state.akhir === "") {
      ...
      let url = `http://localhost:4040/cafe/user/tanggal/${this.timeAwal(
        this.state.awal
      ...
      <div class="p-4 sm:ml-64">
        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
          ...
          <div className="flex justify-between items-center m-4">
            <h2 className="dark:text-black text-lg font-sans">Daftar User</h2>
            <div className="flex items-center">
              ...
              <button
                ...
                type="button"
                onClick={(event) => this.getTanggalUser(event)}
              >
                Cari
              </button>
              <button
            ...
            <tbody>
              {this.state.user.map((item) => (
                ...
                >
                  ...
                  <td class="px-6 py-4">{this.convertTime(item.createdAt)}</td>
